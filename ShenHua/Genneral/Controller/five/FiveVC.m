...
-(void)initTableView
{
   ...
   self.tableView =[[UITableView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT) style:UITableViewStyleGrouped];
    //打印大小
    [self.view sd_logFrame:@"self.view"];
    [self.tableView sd_logFrame:@"self.tableview"];
    //设置好代理
...
//    FiveVC * winXinFindVC=[[FiveVC alloc] initWithNibName:@"FiveVC" bundle:nil];
//    winXinFindVC.hidesBottomBarWhenPushed=YES;//隐藏
//    [self.navigationController pushViewController:winXinFindVC animated:YES];
    
    
        TestViewController * winXinFindVC=[[TestViewController alloc] initWithNibName:@"TestViewController" bundle:nil];
        winXinFindVC.hidesBottomBarWhenPushed=YES;//隐藏
        [self.navigationController pushViewController:winXinFindVC animated:YES];
